...
Псоле того как все запустилось,

Home Assistant будет доступен по адресу: ``` http://IP-вашего-контролера:8123 ```

Конфигуратор будет доступен по адресу: ``` http://IP-вашего-контролера:3218 ```
